...
import static com.example.dql.dqldialogtools.DqlTools.DqlConstTool.BYTE;
import static com.example.dql.dqldialogtools.DqlTools.DqlConstTool.GB;
import static com.example.dql.dqldialogtools.DqlTools.DqlConstTool.KB;
import static com.example.dql.dqldialogtools.DqlTools.DqlConstTool.MB;
...
public class DqlDataTool {
     ...
     * @param byteNum 字节数
     * @param unit    <ul>
     *                <li>{@link DqlConstTool.MemoryUnit#BYTE}: 字节</li>
     *                <li>{@link DqlConstTool.MemoryUnit#KB}  : 千字节</li>
     *                <li>{@link DqlConstTool.MemoryUnit#MB}  : 兆</li>
     *                <li>{@link DqlConstTool.MemoryUnit#GB}  : GB</li>
     *                </ul>
     * @return 以unit为单位的size
     */
    public static double byte2Size(long byteNum, DqlConstTool.MemoryUnit unit) {
        if (byteNum < 0) {
            return -1;
        }
        switch (unit) {
     ...
     * @return 字节数
     */
    public static long size2Byte(long size, DqlConstTool.MemoryUnit unit) {
        if (size < 0) {
            return -1;
        }
        switch (unit) {
