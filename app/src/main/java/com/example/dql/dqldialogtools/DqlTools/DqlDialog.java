...
public class DqlDialog extends Dialog {
    ...
    public DqlDialog(Context context, int themeResId) {
        super(context, themeResId);
        initView(context);
    }

    public DqlDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
        initView(context);
    }

    public DqlDialog(Context context) {
        super(context);
        initView(context);
    }
     ...
     */
    public DqlDialog(Context context, float alpha, int gravity) {
        super(context);
