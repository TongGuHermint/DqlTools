 ...
 * 确认 取消 Dialog
 */
public class DqlDialogSureCancel extends DqlDialog {
    ...
    public DqlDialogSureCancel(Context context, int themeResId) {
        super(context, themeResId);
        initView();
    }

    public DqlDialogSureCancel(Context context, boolean cancelable, DialogInterface.OnCancelListener cancelListener) {
        super(context, cancelable, cancelListener);
        initView();
    }

    public DqlDialogSureCancel(Context context) {
        super(context);
        initView();
    }

    public DqlDialogSureCancel(Activity context) {
        super(context);
        initView();
    }

    public DqlDialogSureCancel(Context context, float alpha, int gravity) {
