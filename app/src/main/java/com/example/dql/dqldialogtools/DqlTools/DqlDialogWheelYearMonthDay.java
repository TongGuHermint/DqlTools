...
import com.example.dql.dqldialogtools.wheel.DateArrayAdapter;
import com.example.dql.dqldialogtools.wheel.NumericWheelAdapter;
import com.example.dql.dqldialogtools.wheel.OnWheelChangedListener;
import com.example.dql.dqldialogtools.wheel.WheelView;
...
public class DqlDialogWheelYearMonthDay extends DqlDialog {
    ...
    public DqlDialogWheelYearMonthDay(Context mContext) {
        super(mContext);
    ...
    public DqlDialogWheelYearMonthDay(Context mContext, int beginYear) {
        super(mContext);
        // TODO Auto-generated constructor stub
        this.mContext = mContext;
    ...
    public DqlDialogWheelYearMonthDay(Context mContext, int beginYear, int endYear) {
        super(mContext);
        // TODO Auto-generated constructor stub
        this.mContext = mContext;
        this.beginYear = beginYear;
    ...
    public DqlDialogWheelYearMonthDay(Context mContext, TextView tvTime) {
        super(mContext);
        // TODO Auto-generated constructor stub
        this.mContext = mContext;
        build();
    ...
    private void updateDays(WheelView year, WheelView month, WheelView day) {
        ...
        int maxDays = DqlTimeTool.getDaysByYearMonth(beginYear + year.getCurrentItem(), month.getCurrentItem() + 1);
